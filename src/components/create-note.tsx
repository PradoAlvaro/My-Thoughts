...
export function CreateNote({ onNoteCreated }: NewNoteCardProps) {
  ...
  function handleSaveNote() {
    ...
    setContent('')
    setShouldShowOnboarding(true)
    toast.success('Você criou uma nota')
  }
  ...
  function handleStopRecording() {
    ...
    if (speechRecognition !== null) {
      ...
      // Chama a função handleSaveNote após a gravação ser interrompida
      handleSaveNote()
    }
  }
          ...
          <form className="flex-1 flex flex-col">
            ...
            {isRecording ? (
              ...
              >
                ...
                <span className="text-red-400 group-hover:underline"></span>
              </button>
            ) : (
              <button
                type="submit"
